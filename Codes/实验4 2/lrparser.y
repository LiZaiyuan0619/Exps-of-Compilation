...
GlobalDecl: GlobalConstDecl{$1->if_const += 3;$$ = $1;}
          | GlobalVarDecl{$1->if_const += 3;$$ = $1;}
          ;
...
FuncParams: FuncParam 
           | FuncParams Y_COMMA FuncParam {past node=$1;while(node->next!=NULL) node = node->next;node->next = $3; $$ = $1;}
           ;
